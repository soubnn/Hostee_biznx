            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{ route('upcoming_events.index') }}" key="t-task-requests">View Events</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{ route('project.delivered') }}" key="delivered-projects">Delivered
                                Projects</a></li>
                        <li><a href="{{ route('project.rejected') }}" key="returned-projects">Rejected Projects</a>
                        </li>
                    </ul>
                </li>
                <li>
