<!-- Modal -->
<div id="single_payment_modal" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h6>Balance Amount : <strong>{{$total_balance}}</strong></h6>
                <form method="POST" action="{{ route('customers.add_single_payment',$id) }}">
                    @csrf
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="col-lg-12">
                            <input type="number" name="amount" min="0" step="0.01" max="{{ round($total_balance,2) }}" value="{{ round($total_balance,2) }}" placeholder="Amount" class="form-control">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="col-lg-12">
                            <select name="accounts" class="form-control select2" style="width: 100%" data-dropdown-parent="#single_payment_modal">
