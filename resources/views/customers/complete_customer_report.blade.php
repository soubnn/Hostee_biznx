...
<body>
    ...
    <div class="add-detail mt-10">
        <div class="w-50 float-left mt-10">
            <p class="m-0 pt-5 text-bold w-100">Customer Name : <span class="gray-color">{{ strtoupper($customerDetails->name) }}</span></p>
            <p class="m-0 pt-5 text-bold w-100">Total Sale Amount : <span class="gray-color">RS. {{ $totalPurchaseAmount }}</span></p>
        ...
        <table class="table w-100 mt-10">
            ...
            <tbody>
                ...
                @foreach ($combinedData as $data)
                    <tr style="text-align: center; @if ($data['debit'] == '') color: green @endif">
