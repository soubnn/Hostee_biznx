                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="invoice-title">
                                            ...
                                            @endphp
                                            <h4 class="float-end font-size-16">Estimate No : <span style="color:red:">{{ 'EST'.$estimate->id.$est_string }}</span></h4>
                                            <div class="mb-4">
                                        ...
                                        <div class="py-2 mt-3" style="text-align: center;">
                                            <h3 class="font-size-18 fw-bold">Estimate Details</h3>
                                        </div>
                                        <div class="py-2 mt-3">
                                            <h3 class="font-size-15 fw-bold">Estimate summary</h3>
                                        </div>
                                                        ...
                                                        @if($estimate_details->product_name)
                                                            <tr>
                                                                ...
                                                                @else
                                                                    ...
                                                                    @endif
                                                                @endif
                                                                <td class="text-end">{{ $estimate_details->warrenty }}</td>
                                            ...
                                            <div class="float-end">
                                                <a href="{{ route('generate_estimate',$estimate->id ) }}" target="_blank">
                                                    <button type="button"  class="btn btn-success waves-effect waves-light me-1">
                                                        ...
                                                        <span style="margin-left:10px;font-weight:500;">Print Estimate</span>
                                                    </button>
                                                </a>
                                            </div>
                                        </div>
