...
@section('content')
    ...
    <script>
            ...
            if (category_name == '') {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response != "Error") {
                            var newOption = "<option value='" + response.id + "' >" + response.category_name +
                                "</option>";
        ...
        //         if (new_category === "" || new_category === "SELECT" || new_category ===
        ...
        //                 // console.log(response);
        //                 if (response != "Error") {
        //                     var newOption = "<option value='" + response.id +
        //                         "' selected>" + response.category_name + "</option>";
        //                     $("#category_id").append(newOption);
        //                 }
        //             }
        //         });
                                ...
                                <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input style="text-transform: uppercase;" id="productname"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control select2" name="category_id" id="category_id" onchange="category_modal(this.value)"
                                                    value="{{ old('category_id') }}" requried>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control select2" id="product_schedule"
                                                    name="product_schedule" onchange="getGST(this.value)">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input id="hsn_code" name="hsn_code" type="text"
                                            ...
                                            <div class="mb-3">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input id="product_sgst" name="product_sgst" type="text"
                                                            class="form-control" value="{{ old('product_sgst') }}">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="tax">Central GST</label>
                                                        <input id="product_cgst" name="product_cgst" type="text"
                                                            class="form-control" value="{{ old('product_cgst') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        {{-- <div class="col-sm-6 mt-3">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control select2" id="product_supplier"
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <button type="submit" class="btn btn-primary waves-effect waves-light"
                                            onclick="this.disabled=true;this.innerHTML='Saving..';this.form.submit();">Save
                                            Details</button>
                                    </div>
                                </form>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 text-end">
                                                    <button type="button" class="btn btn-primary"
                                                        onclick="this.disabled=true;this.innerHTML='Saving..';add_new_category();">Save</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
