            ...
            $.ajax({
                ...
                success : function(response)
                {
                    ...
                    for(var i = 0; i < response.length; i++)
                    {
                        ...
                        newDynamicOption.innerHTML = "[" + response[i].product_code +"]" + response[i].product_name +" ( " + response[i].stock + " )";
                        ...
                        {   if(productValue != 159)
                            {
                                ...
                                else
                                {
                                    ...
                                    document.getElementById("priceWithTax"+row).value = response.product_price;
        ...
        if (isValid) 
        {
            ...
            $.ajax({
                ...
                success : function(response)
                {
                    ...
                    if(response != "Error")
                    {
                        var newOption = "<option value='" + response.id + "'>" + response.name + ", " + response.place + "</option>";
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('directSales.store') }}" method="POST" enctype="multipart/form-data" id="salesForm" autocomplete="off">
                                            @csrf
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        <label for="invoice_number">Invoice No</label>
                                                        <input id="invoice_number" name="invoice_number" type="text" class="form-control" value="{{ old('invoice_number') }}" readonly>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="customer_phone" name="customer_phone" type="tel" class="form-control" value="{{ old('customer_phone') }}" pattern="[0-9]{10}">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input for="labelYes" id="GSTYes" name="gst_available" type="radio" value="Yes" onclick="showGSTNumber(this.value)">
                                                            </div>
                                                            <div class="col-md-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control select2" name="pay_method" id="pay_method" onchange="enable_btn()" required>
                                                    ...
                                                    <div class="mb-3 autocomplete">
                                                        <label class="control-label">Customer Name</label>
                                                        <input id="customer_name" name="customer_name" type="hidden" style="text-transform: uppercase">
                                                        <select id="customer_id" name="customer_id" type="text" class="form-control select2" style="text-transform: uppercase" required onchange="getCustomerDetails(this.value)">
                                                        ...
                                                        <small id="customerNameError1" style="display: none" class="text-danger">Customer Name cannot be empty!</small>
                                                        @error('customer_id')
                                                            <span class="text-danger">Customer is required. Please select a customer    </span>
                                                        @enderror
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="sales_staff">Sales Person</label>
                                                        <select id="sales_staff" name="sales_staff" class="form-control select2" onchange="enable_btn()" required>
                                                    ...
                                                    <div class="mb-3" id="gstDiv" style="display: none">
                                                        ...
                                                        <input id="gst_number" name="gst_number" type="text" class="form-control" value="{{ old('gst_number') }}">
                                                                        ...
                                                                        <td id="prod0" style="max-width: 150px;">
                                                                            <select class="select2 products" style="width: 100%" id="productSelect0" name="productSelect[]" onchange="productSelected(this.value,0)">
                                                                                ...
                                                                                @foreach ($inStockProducts as $product)
                                                                                    @php
                                                                                        $products = DB::table('products')->where('id',$product->product_id)->first();
                                                                                        $stocks = DB::table('stocks')->where('product_id',$products->id)->first();
                                                                                    @endphp
                                                                                    <option value="{{ $products->id }}">[{{ $products->product_code }}] {{ $products->product_name }} ( {{ $stocks->product_qty }} )</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </td>
                                                                        <td><input class="form-control" type="text" value="" id="serial0" name="serial[]" style="width: 100%; text-transform: uppercase"></td>
                                                                        <td><input class="form-control" type="number" value="" id="priceWithTax0" step=".01"  min="0" onkeyup="calculateTotal(0)" onchange="calculateTotal(0)" style="width: 100%"></td>
                                                                        {{--  <td><span id="unitPrice0" name="unitPrice[]" onchange="calculateTotal(0)">₹0</span></td>  --}}
                                                                        <td><input class="form-control" type="number" value="" id="unitPrice0" name="unitPrice[]" step=".01" onchange="calculateTotal(0)" style="width: 100%" readonly></td>
                                                                        <td id="qtyTD0"><input class="form-control" id="productQty0" name="productQty[]" type="number" step=".10" value="1" onkeyup="calculateTotal(0)" min="0" onchange="calculateTotal(0)" style="width: 100%"></td>
                                                                        <td id="total0" onchange="calculateGSTAndTotal(0)">₹0</td>
                                                                        <td>
                                                                            <select class="form-control" name="productTax[]" id="product_tax0" onchange="calculateNewGST(this.value,0)" style="width:100%;">
