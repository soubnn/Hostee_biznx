...
<html>
<head>
    <title>Sales GST Report - Techsoul Cyber Solutions</title>
</head>
<style type="text/css">
    body{
...
<div class="head-title">
    <div>
        <h3 class="m-0 p-0 w-100" style="text-align: right">Sales GST Report</h3>
...
<div class="table-section bill-tbl w-100 mt-10">
    ...
    @endphp
    <div class="footer">
        <span>generated by {{ $printed_by }} on {{ $printed_on }}</span>
    </div>
</div>
</html>
