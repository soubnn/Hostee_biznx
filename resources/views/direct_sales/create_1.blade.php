...
@section('content')
    ...
    function enable_btn(){
        ...
        console.log('pay_method '+pay_method+' customer_name '+customer_name+' sales_person '+sales_person);
        if( pay_method == '' || customer_name == '' || sales_person == ''){
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="sales_date" name="sales_date" type="date" class="form-control" value="{{ Carbon\carbon::now()->format('Y-m-d') }}" max="{{ Carbon\carbon::now()->format('Y-m-d') }}" min="{{ Carbon\carbon::now()->format('Y-m-d') }}" readonly>
                                                        @error('sales_date')
                                                            <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                    </div>
