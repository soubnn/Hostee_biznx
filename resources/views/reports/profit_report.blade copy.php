            ...
            <tbody>
                ...
                @foreach ( $sales_details as $sales_detail)
                        ...
                        <tr>
                            ...
                            @else
                                ...
                                @php
                                    ...
                                    $total_item_purchase_amount = $purchase_amount * $item->product_quantity;
                                ...
                                @php
                                    ...
                                    $t_profit += $profit;
                                @endphp
                                <td>{{ number_format($purchase_amount, 2, '.', '') }}X{{ $item->product_quantity }}<br><b>{{ $total_item_purchase_amount }}</b></td>
                    ...
                    <tr>
                        ...
                        <th>{{ $t_qty }}</th>
                        <th>{{ number_format($t_bill_amount, 2, '.', '') }}</th>
                        {{--  <th>{{ number_format($t_rate, 2, '.', '') }}</th>  --}}
                        <th>{{ number_format($t_purchase_amount, 2, '.', '') }}</th>
                        <th>{{ number_format($t_profit, 2, '.', '') }}</th>
                        <th>{{ number_format($t_search_amount, 2, '.', '') }}</th>
                        {{--  <th>{{ number_format($t_to_techsoul, 2, '.', '') }}</th>  --}}
                        <th></th>
                    </tr>
                    @endif
                @endforeach
                <tr>
                    ...
                    {{--  <th>{{ number_format($total_rate_of_item, 2, '.', '') }}</th>  --}}
                    ...
                    {{--  <th>{{ number_format($total_amount_to_techsoul, 2, '.', '') }}</th>  --}}
                    <th></th>
                </tr>
            </tbody>
        </table>
