...
<head>
    <title>Monthly Report - Hostee the Planner</title>
</head>
<style type="text/css">
    body {
...
<body>
    ...
    <div class="table-section bill-tbl w-100">
        <p class="m-0 pt-5 text-bold w-100">Invoice Amount By Sale : <span
                class="gray-color">{{ round($totalSalesAmount, 2) }}</span></p>
        {{-- <p class="m-0 pt-5 text-bold w-100">Invoice Amount By Jobcard  : <span class="gray-color">{{ round($totalJobAmount,2) }}</span></p> --}}
        <p class="m-0 pt-5 text-bold w-100">Total Amount : <span
                class="gray-color">{{ round($totalSalesAmount + $totalJobAmount, 2) }}</span></p>
    </div>
    <br>
    <div class="table-section bill-tbl w-100">
        <p class="m-0 pt-5 text-bold w-100">Recieved Against Sales : <span
                class="gray-color">{{ round($salesAmount, 2) }}</span></p>
        {{-- <p class="m-0 pt-5 text-bold w-100">Recieved Against JobCard  : <span class="gray-color">{{ round($jobAmount,2) }}</span></p> --}}
        <p class="m-0 pt-5 text-bold w-100">Total Amount : <span
                class="gray-color">{{ round($salesAmount + $jobAmount, 2) }}</span></p>
    </div>
    <div class="head-title">
    ...
    <div class="table-section bill-tbl w-100">
        <p class="m-0 pt-5 text-bold w-100">Total Expense : <span
                class="gray-color">{{ round($totalExpenseInPeriod, 2) }}</span></p>
    ...
    <div class="table-section bill-tbl w-100">
        ...
        <p class="m-0 pt-5 text-bold w-100">Invoice Amount from Jobcards : <span
                class="gray-color">{{ round($totalJobAmount, 2) }}</span></p>
        <p class="m-0 pt-5 text-bold w-100">Income from Jobcards : <span
                class="gray-color">{{ round($jobAmount, 2) }}</span></p>
        <p class="m-0 pt-5 text-bold w-100 mt-25">Total Income : <span
                class="gray-color">{{ round($totalIncomeInPeriod, 2) }}</span></p>
        <p class="m-0 pt-5 text-bold w-100">Total Expense : <span
                class="gray-color">{{ round($totalExpenseInPeriod, 2) }}</span></p>
    </div> --}}
    <div class="footer">
