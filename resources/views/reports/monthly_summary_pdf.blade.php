...
<html>
<head>
    <title>Monthly Summary - Techsoul Cyber Solutions</title>
</head>
<style type="text/css">
    body{
...
<div class="table-section bill-tbl w-100">
    <p class="m-0 pt-5 text-bold w-100">Invoice Amount By Sale(Generated in {{ Carbon\carbon::parse($search_date)->format('F') }}) : <span class="gray-color">{{ $total_sales_amount }}</span></p>
    <p class="m-0 pt-5 text-bold w-100">Invoice Amount By Jobcard(Generated in {{ Carbon\carbon::parse($search_date)->format('F') }})  : <span class="gray-color">{{ $total_job_amount }}</span></p>
    <p class="m-0 pt-5 text-bold w-100">Total Amount(Generated in {{ Carbon\carbon::parse($search_date)->format('F') }})  : <span class="gray-color">{{ $total_sales_amount+$total_job_amount }}</span></p>
    <br>
    <p class="m-0 pt-5 text-bold w-100">Total Income(Recieved in {{ Carbon\carbon::parse($search_date)->format('F') }})  : <span class="gray-color">{{ $total_income }}</span></p>
</div>
...
<div class="table-section bill-tbl w-100">
    <p class="m-0 pt-5 text-bold w-100">Total Expense  : <span class="gray-color">{{ round($total_expense,2) }}</span></p>
