                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">profile/view
                                                profile</a></li>
                                    </ol>
                                </div>
                                        ...
                                        <div class="flex-grow-1">
                                            <div>
                                                <img src="{{ asset('storage/images/' . $profile->image) }}" alt=""
                                                    style="object-fit: cover" class="img-fluid mx-auto profile-images">
                                            </div>
                                        </div>
                                                ...
                                                <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="POST"
                                                                action="{{ route('editprofileimage', $profile->id) }}"
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="submit"
                                                                        class="btn btn-primary">Upadte</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
                                ...
                                <div class="card-body border-top">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="text-sm-end mt-4 mt-sm-0">
                                                <button type="button" class="btn btn-light waves-effect text-success"
                                                    href="#" id="editname" data-id="#up-name" data-bs-toggle="modal"
                                                    data-bs-target=".bs-example-modal-lg">
                                                    <i class="mdi mdi-pencil font-size-18"></i>
                                                </button>
                                                <!-- Modal -->
                                                <div id="modalForm" class="modal fade bs-example-modal-lg" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered  modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form method="POST"
                                                                    action="{{ route('editprofilename', $profile->id) }}">
                                                                    @csrf
                                                                    @method('PATCH')
                                                                    <div class="form-group mb-3">
                                                                        <label for="profilename" class="col-form-label"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-12 text-end">
                                                                            <button type="submit" class="btn btn-primary"
                                                                                id="addtask">Update Changes</button>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form method="POST"
                                                                    action="{{ route('editpassword', $profile->id) }}">
                                                                    @csrf
                                                                    @method('PATCH')
                                                                    <div class="form-group mb-3">
                                                                        <label for="taskname" class="col-form-label"
                                                                            style="float:left;">New Password</label>
                                                                        <div class="col-lg-12">
