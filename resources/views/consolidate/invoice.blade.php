                ...
                <tr>
                  ...
                  <td width="40%" valign="top" style="padding: 0;">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr style="border-bottom: 2px solid #dddddd;">
                        <td colspan="2" style="font-size: 11px;padding-bottom: 8px;">
          ...
          <td style="padding: 0;margin: 0;">
            <table width="100%" class="invtable" border="0" cellpadding="0" cellspacing="0" align="center" style="border: 1px solid #000000;border-left: 1px solid #918f8e;margin: 0;margin-top:15px;">
              ...
              @php
                ...
                $sgst_total=0;
                $cgst_total=0;
                $product_count = DB::table('sales_items')->where('sales_id',$completeReportDetails['sales_id'] )->count();
              @endphp
            @if($product_count < 20 )
            ...
            @foreach($completeReportDetails['sales_items'] as $item)
              ...
              <tr>
                ...
                @elseif($name_length > 200 && $name_length <= 225)
                    ...
                    @endphp
                        <td>{{ $product_name1 }}<br>{{ $product_name2 }}<br>{{ $product_name3 }}<br>{{ $product_name4 }}<br>{{ $product_name5 }}<br>{{ $product_name6 }}<br>{{ $product_name7 }}<br>{{ $product_name8 }}<br>{{ $product_name9 }}</td>
                    @php
                ...
                @elseif($name_length > 225)
                    ...
                    @endphp
                        <td>{{ $product_name1 }}<br>{{ $product_name2 }}<br>{{ $product_name3 }}<br>{{ $product_name4 }}<br>{{ $product_name5 }}<br>{{ $product_name6 }}<br>{{ $product_name7 }}<br>{{ $product_name8 }}<br>{{ $product_name9 }}<br>{{ $product_name10 }}</td>
                    @php
                ...
                @php
                    $unit_price = number_format((float)$item['sales_price'], 2, '.', '');
                @endphp
                <td>{{ $unit_price }}</td>
                @php
                    $amount = round($item['product_quantity'] * $item['sales_price'],2);
                @endphp
                ...
                @foreach($completeReportDetails['sales_items'] as $item)
                    @if ($count == 25)
                        <tr style="border: white !important;">
                            <td style="border-top: 1px solid;border-left:none;border-right:none;border-bottom:none;"></td>
                            <td style="border-top: 1px solid;border-left:none;border-right:none;border-bottom:none;"></td>
                            <td style="border-top: 1px solid;border-left:none;border-right:none;border-bottom:none;"></td>
                            <td style="border-top: 1px solid;border-left:none;border-right:none;border-bottom:none;"></td>
                            <td style="border-top: 1px solid;border-left:none;border-right:none;border-bottom:none;"></td>
                    ...
                    @endphp
                  <tr>
                    <td style="text-align: center;" @if($count == 25) class="border_black" @endif>{{ $no }}</td>
                    @php
                        $name_length = strlen($product_name);
                    @endphp
                        {{ $name_length }}
                    ...
                    @else
                        ...
                        @endphp
                    @endif
                    <td @if($count == 25) class="border_black" @endif>{{ $productDetails->hsn_code }}</td>
                    <td @if($count == 25) class="border_black" @endif>{{ $item['product_quantity'] }}</td>
                    @php
                        $unit_price = number_format((float)$item['sales_price'], 2, '.', '');
                    @endphp
                    <td @if($count == 25) class="border_black" @endif>{{ $unit_price }}</td>
                    @php
                        $amount = round($item['product_quantity'] * $item['sales_price'],2);
                    @endphp
                    <td @if($count == 25) class="border_black" @endif>{{ number_format((float)$amount, 2, '.', '') }}</td>
                    <td @if($count == 25) class="border_black" @endif>{{ number_format((float)$amount, 2, '.', '') }}</td>
                    @php
                        $sgst = $cgst = ($item['gst_percent'])/2;
                    @endphp
                    <td style="text-align: right;" @if($count == 25) class="border_black" @endif>{{ $sgst }}</td>
                    @php
                        $sgst_value = round(($amount*$sgst)/100,2);
                    @endphp
                    <td style="text-align: right;" @if($count == 25) class="border_black" @endif>{{ number_format((float)$sgst_value, 2, '.', '') }}</td>
                    <td style="text-align: right;" @if($count == 25) class="border_black" @endif>{{ $cgst }}</td>
                    @php
                        $cgst_value = round(($amount*$cgst)/100,2);
                    @endphp
                    <td style="text-align: right;" @if($count == 25) class="border_black" @endif>{{ number_format((float)$cgst_value, 2, '.', '') }}</td>
                    <td style="text-align: right;" @if($count == 25) class="border_black" @endif> {{ $item['sales_price'] }}</td>
                </tr>
                  @php
                      $no++;
                      $sgst_total = $sgst_total+$sgst_value;
                  ...
                  <tr>
                    ...
                    <td width="40%" valign="top" style="padding: 0;">
                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <thead>
                        <tr>
                            <td style="color:#fa2424;font-size: 14px;font-weight: bolder;text-align: left;padding: 0;">OFFICE COPY</td>
                            <td style="color:#215967;font-size: 20px;font-weight: bolder;text-align: right;padding: 0;">RETAIL INVOICE</td>
                        </tr>
                        <tr style="border-bottom: 2px solid #dddddd;">
                          <td style="font-size: 14px;padding-bottom: 10px;"><small>Invoice No</small><br/><span class="red" style="color: #c00000;font-weight: bold;">{{ $completeReportDetails['invoice_number'] }}</span></td>
                          <td style="font-size: 14px;padding-bottom: 10px;padding-left: 50px;"><small>Date</small><br/><span class="red" style="color: #c00000;font-weight: bold;">{{ $completeReportDetails['invoice_date'] }}</span></td>
                        </tr>
                        <tr style="border-bottom: 2px solid #dddddd;">
                          <td colspan="2" style="font-size: 11px;padding-bottom: 8px;">
                            <span style="display: block;">Customer Details</span>
