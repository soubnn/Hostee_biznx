    ...
    <div class="top_headder" style="padding: 0;margin-left:-15px;">
        <div class="container_banner">
            <div class="banner_body">
                <table border="0" class="table topbanner mystyle" style="margin-bottom:10px;width: 100%"
                    width="100%">
                    <tbody>
                        <tr>
                            <td style="padding: 0;">
                                ...
                                <table width="100%" class="invtable" border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <thead>
                                        <tr style="height: 30px;">
                                            ...
                                            <th rowspan="2" width="135" style="border: 1px solid;">Description of
                                                Goods</th>
                                            <th rowspan="2" width="35" style="border: 1px solid;">HSN CODE
                                                <br />(GST)</th>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td style="border: 1px solid"></td>
                                            <td style="border: 1px solid">{{ number_format($sgst_total, 2, '.', '') }}
                                            </td>
                                            <td style="border: 1px solid"></td>
                                            <td style="border: 1px solid">{{ number_format($cgst_total, 2, '.', '') }}
                                            </td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid">
                                                ...
                                                <b>ACCOUNT NUMBER</b> : 53250001177379 &nbsp;&nbsp;<b>IFSC</b> :
                                                ESMF0001127
                                            </td>
                                            <td
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <td style="text-align: right;">This is a system generated
                                                invoice<br />Hence, no signature is required.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
