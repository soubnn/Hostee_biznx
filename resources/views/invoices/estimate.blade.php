                                                    ...
                                                    <thead>
                                                        ...
                                                        <tr style="border-bottom: 2px solid #dddddd;">
                                                            <td style="font-size: 14px;padding-bottom: 10px;">
                                                                @php
                                                                    $current_month = Carbon\carbon::parse($estimate->estimate_date)->format('m');
                                                                    $current_year = Carbon\carbon::parse($estimate->estimate_date)->format('y');
                                                                    if($current_month >= 4){
                                                                ...
                                                                @endphp
                                                                <small>Estimate No</small><br /><span class="red" style="color: #c00000;font-weight: bold;">{{ 'EST'.$estimate->id.$est_string }}</span>
                                                            </td>
                                                            <td style="font-size: 14px;padding-bottom: 10px;">
                                                                <small>Date</small><br /><span class="red" style="color: #c00000;font-weight: bold;">
                                                                    {{ Carbon\carbon::parse($estimate->estimate_date)->format('d F Y');  }}
                                                                </span>
                                                            </td>
                                                        </tr>
                                                        <tr style="border-bottom: 2px solid #dddddd;">
                                                            <td colspan="2"
                                                                ...
                                                                <strong style="display: block;">
                                                                    {{ $estimate->customer_name }}<br>{{ $estimate->customer_phone }}
                                                                </strong>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" style="font-size: 12px;">
                                                                <span style="display: block;">Valid Upto</span>
                                                                <strong style="display: block;color: #c00000;font-weight: bold;">{{ Carbon\carbon::parse($estimate->valid_upto)->format('d F Y');  }}</strong>
                                                            </td>
                                                        </tr>
                                                    </thead>
                                                </table>
                                    ...
                                    <table width="100%" class="invtable" border="0" cellpadding="0" cellspacing="0" align="center" style="border: 1px solid #000000;border-left: 1px solid #918f8e;margin: 0;margin-top:15px;">
                                        <thead>
                                            <tr style="height: 30px;">
                                                <th rowspan="2" width="15" style="border: 1px solid;text-align: center;">SL.<br/>NO</th>
                                                <th rowspan="2"  width="135" style="border: 1px solid;">Description of Goods</th>
                                                <th rowspan="2"  width="35" style="border: 1px solid;">Warrenty</th>
