                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Upcoming Events Form</h4> <!-- Updated Heading -->
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item">upcoming events/<a href="{{ route('news_events.create') }}">add events</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
