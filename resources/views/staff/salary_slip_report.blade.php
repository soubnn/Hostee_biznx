...
<body>
    {{-- <page size="A4">
        ...
        <table style="border-collapse: collapse; margin: 25px;" cellspacing="0">
            <tr>
                <td colspan="4">
                    <p style="text-indent: 0pt;text-align: left;height: 0px;"><br /></p>
                </td>
            </tr>
            <tr>
                                ...
                                <tr>
                                    <td style="text-align: center;">
                                        <img src="assets/images/logo.png" width="50%"
                                            style="margin: 5px; margin-right: 26px; margin-top: -10px;">
                                    </td>
                                </tr>
                            </table>
                        </span>
            ...
            <tr style="height:24px">
                <td
                    ...
                    <p class="s2"
                        style="padding-top: 3pt;padding-left: 5pt;text-indent: 0pt;line-height: 14pt;text-align: left;">
                        Employee Name</p>
                </td>
                <td
                    ...
                    <p class="s3"
                        style="padding-top: 4pt;padding-left: 5pt;text-indent: 0pt;line-height: 12pt;text-align: left;">
                        {{ $staff->staff_name }}</p>
                </td>
                <td
                    style="width:30%;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                ...
                <td
                    style="width:20%;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                    <p class="s4"
                        style="padding-top: 3pt;padding-left: 14pt;padding-right: 13pt;text-indent: 0pt;line-height: 14pt;text-align: center;">
                        {{ Carbon\carbon::parse($salaryPayment['date'])->format('d-m-Y') }}</p>
                </td>
            </tr>
            <tr style="height:24px">
                <td
            ...
            <tr style="height:24px">
                ...
                <td
                    ...
                    <p class="s3"
                        style="padding-top: 4pt;padding-left: 5pt;text-indent: 0pt;line-height: 12pt;text-align: left;">
                        {{ $salaryPayment['payment_method'] }}</p>
                </td>
                <td
                    style="border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                    <p class="s2"
            ...
            <tr style="height:26px">
                <td style="width:50%;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt;background-color: #4085C0;"
                    colspan="2">
            ...
            <tr>
                <td style="width:50%;border-right-style:solid;border-right-width:1pt;border-left-style:solid;border-left-width:1pt;"
                    colspan="2">
                    <table style="width:100%" cellspacing="0">
                        <tr style="height:25px">
                            <td
                                style="width:60%;border-bottom-style:solid;border-bottom-width:1pt;background-color: #478ac373 ;">
                                <p class="s1"
                                    style="padding-left: 5pt;text-indent: 0pt;line-height: 16pt;text-align: left;">
                                    Particulars
                                </p>
                            </td>
                            <td
                                style="width:40%;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;background-color: #478ac373 ;">
                                <p class="s1"
                                    style="padding-left: 5pt;text-indent: 0pt;line-height: 16pt;text-align: left;">
                                    Amount</p>
                            </td>
                        ...
                        <tr style="height:24px">
                            ...
                            <td
                                ...
                                <p class="s4"
                                    style="padding-top: 3pt;padding-left: 52pt;padding-right: 51pt;text-indent: 0pt;line-height: 14pt;text-align: center;">
                        ...
                        <tr style="height:24px">
                            ...
                            <td
                                style="border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;">
                                <p class="s1"
                                    style="padding-right: 4pt;text-indent: 0pt;line-height: 16pt;text-align: right;">
                                    {{ $totalIncomAmount }}</p>
                            </td>
                        </tr>
                    </table>
            ...
            <tr style="height:26px">
                <td style="width:70%;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt;background-color: #4085C0;"
                    colspan="3">
                ...
                <td
                    style="width:30%;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                    <p class="s1"
                        style="padding-left: 13pt;padding-right: 13pt;text-indent: 0pt;line-height: 16pt;text-align: center;">
            ...
            <tr style="height:65px">
                <td
                    style="border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt"colspan="2">
                    <p style="text-indent: 0pt;text-align: left;"><br></p>
                    <p style="text-indent: 0pt;text-align: left;"><br></p>
                    <p style="text-indent: 0pt;text-align: left;"><br></p>
                </td>
                <td style="border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt; position: relative;"
                    colspan="2">
                    <p style="text-indent: 0pt;text-align: left; position: relative;">
                        <img src="assets/images/ceosign.png"
                            style="height: 110px;position: absolute;top: -22px;left: 161px;">
                    </p>
                </td>
            </tr>
            <tr style="height:24px">
                <td style="border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt"
                    colspan="2">
                    <p class="s1" style="padding-left: 64pt;text-indent: 0pt;line-height: 16pt;text-align: left;">
                        Employee Signature</p>
                </td>
                <td style="width:290pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt"
                    colspan="2">
                    <p class="s1" style="padding-left: 87pt;text-indent: 0pt;line-height: 16pt;text-align: left;">
    ...
    <page size="A4">
        <table>
            ...
            <tr>
                ...
                <td>Term</td>
                <td class="text-center" style="font-weight: 700">{{ $termData }}</td>
            </tr>
            <tr>
                <td>Designation</td>
            ...
            <tr>
                ...
                <td>Leave</td>
                <td class="text-center" style="font-weight: 700">{{ $leave }}</td>
            </tr>
            <tr>
        ...
        <table>
            ...
            <tr>
                ...
                <td>Leave</td>
                <td class="text-right" style="font-weight: 700">{{ $leaveAmount }}</td>
            </tr>
            @foreach ($dataArray as $item)
                <tr>
                    <td>{{ $item['name'] }}</td>
            ...
            <tr>
                ...
                <td>Paid Amount</td>
                <td class="text-right"><b>{{ $paidAmount }}</b></td>
            </tr>
            ...
            <tr>
                ...
                <td></td>
                <td class="text-right"><b>Total</b></td>
                <td class="text-right"><b>{{ $deductions }}</b></td>
            </tr>
        </table>
        ...
        <table style="margin-top: 10px">
            <tr class="text-center" style="font-weight: 700">
                <td colspan="2" style="height: 50px;">Employee Signature</td>
                <td colspan="2" style="position: relative; height: 50px;">
                    <img src="assets/images/ceosign.png"
                        style="height:80px; position:absolute; bottom:-10px; right:120px;">
                    Employer Signature
                </td>
            </tr>
        </table>
