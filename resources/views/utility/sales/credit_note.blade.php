                        ...
                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td width="40%" valign="top" style="padding: 0;">
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                        <thead>
                                                            <tr>
                                                                <td colspan="2" style="color:#a50d14;font-size: 14px;font-weight: bolder;text-align: right;padding: 0;">CREDIT NOTE</td>
                                                            </tr>
                                                            <tr style="border-bottom: 2px solid #dddddd;">
                                                                <td style="font-size: 13px;padding-bottom: 10px;"><small>Credit Note No</small><br/><span class="red" style="color: #c00000;font-weight: bold;">{{ $invoice_details['credit_no'] }}</span></td>
                                    ...
                                    <table width="100%" class="invtable" border="0" cellpadding="0" cellspacing="0" align="center" style="border: 1px solid #000000;margin: 0;margin-top:15px;">
                                        ...
                                        <tbody style="vertical-align: top;" valign="top">
                                            @php
                                                ...
                                                $net_qty = 0;
                                            @endphp
                                            @foreach ( $invoice_details['sales_items'] as $item)
                                                <tr>
                                                    @php
                            ...
                            <tr>
                                <td style="font-size: 11px;padding: 8px 0;">
                                  <b>TERMS AND CONDITIONS : </b>1. This credit note is issued to account for the return of goods specified in the invoice referenced above. The recipient is kindly requested to review the details and make the necessary adjustments.
                                  2. The recipient agrees to process the adjustment within 30 days from the date of this credit note. Failure to do so may result in additional charges as per the agreement.
                                  3. Any supporting documentation related to the returned goods, such as return authorization, packaging slips, and images of the goods, should be provided along with the adjustment.
                                  4. In case of any dispute regarding the credit note, both parties agree to resolve the matter through mediation in accordance with the laws.
                                  5. The recipient acknowledges the receipt and acceptance of this credit note by signing below or confirming electronically.
                                </td>
                            </tr>
                            <tr>
                                <td>
