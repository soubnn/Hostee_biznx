        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Purchase MANAGEMENT
                            </h4>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        <label>Ref No</label>
                                        <input type="text" value="{{ $purchase->ref_no }}" class="form-control" disabled>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label>Invoice No</label>
                                        <input type="text" value="{{ $purchase->invoice_no }}" class="form-control" disabled>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label>Seller Name</label>
                                        <input type="text" value="{{ $seller->seller_name }}" class="form-control" disabled>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label>Purchase Date</label>
                                        <input type="text" value="{{ Carbon\carbon::parse($purchase->invoice_date)->format('d-M-Y') }}" class="form-control" disabled>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label>No Of Items</label>
                                        <input type="text" value="{{ $purchase_count }}" class="form-control" disabled>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label>No Of Products</label>
                                        <input type="text" value="{{ $purchase_products_count }}" class="form-control" disabled>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label>Discount</label>
                                        <input type="text" value="{{ $purchase->discount }}" class="form-control" disabled>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label>Total Amount</label>
                                        <input type="text" value="{{ $purchase->grand_total }}" class="form-control" disabled>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label>Purchase Bill</label>
                                        @if ($purchase->purchase_bill)
                                            <div>
                                                <a href="{{ asset('storage/purchase/'.$purchase->purchase_bill) }}" target="_blank">{{ $purchase->invoice_no.'- purchase bill' }}</a>
                                            </div>
                                        @endif
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Purchase Items
                            </h4>
                        </div>
                    </div>
                </div>
                                        ...
                                        @foreach($purchase_items as $item)
                                            ...
                                            @endif
                                                <td style="white-space: normal">
                                                    ...
                                                    @endphp
                                                    {{ $product->product_name }} ({{ $cat_name->category_name }})
                                                </td>
                                                ...
                                                <td style="white-space: normal">{{ $item->purchase_price }}</td>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title add-task-title">Return Purchase Items</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <form action="{{ route('utility.purchase_items.return',$purchase->id) }}" method="POST">
                                                @csrf
                                                <div class="modal-body">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="form-check font-size-16">
                                                                                <input class="form-check-input item_check" type="checkbox" id="verify_details_{{ $index }}" name="purchase_item[]" value="{{ $item->id }}" style="border-color: #000;" onclick="toggleQuantityInput({{ $index }})">
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            @php
                                                                        ...
                                                                        <td>{{ $item->product_quantity - $item->returned }}</td>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select class="form-control" name="payment_status" id='payment_status' onchange="show_method()" style="width:100%;">
                                                                <option value="not paid">Add to Seller Balance</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 text-end">
                                                            <button type="submit" class="btn btn-primary" onclick="this.disabled=true;this.innerHTML='Seving...';this.form.submit();">Return Purchase</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
