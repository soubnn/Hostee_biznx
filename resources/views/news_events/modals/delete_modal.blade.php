<!-- Delete Modal -->
                                    <div id="delete_modal{{ $event->id }}" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <form method="POST" action="{{ route('news_events.destroy', $event->id) }}">
                                                        @csrf
                                                        @method('DELETE')
