...
<script>
    ...
    {
        var amount = parseFloat($("#price_"+row).val());
...
<script>
    ...
    function show_fields(service){
        if(service == 'chiplevel'){
            document.getElementById('chip_servicer_div').style.display = 'block';
            document.getElementById('warrenty_servicer_div').style.display = 'none';
            document.getElementById('servicer_contact_div').style.display = 'block';
            document.getElementById('staff_div').style.display = 'block';

        }
        else if(service == 'warrenty'){
            document.getElementById('chip_servicer_div').style.display = 'none';
            document.getElementById('warrenty_servicer_div').style.display = 'block';
            document.getElementById('servicer_contact_div').style.display = 'block';
            document.getElementById('staff_div').style.display = 'block';
        }
    }
    function add_servicer(servicer){
        if(servicer == 'add_servicer'){
            ...
            $.ajax({
                ...
                {
                    console.log(response);
                    document.getElementById('servicer_contact').value = response.servicer_contact;
                                    ...
                                    <div class="card-body">
                                           ...
                                           <div class="col-4">
                                                ...
                                                @if($get_chip)
                                                    @if($get_chip->status == 'active')
                                                        <h4 class="card-title mb-4 text-warning">Chip Level : {{ $get_chip->servicer_name }}</h4>
                                                    @endif
                                                @elseif($get_warrenty)
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group mb-3">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <input type="text" class="form-control" name="servicer_name" value="{{ $get_chiplevel->servicer_name }}" readonly>
                                                                    </div>
                                                                    <div class="col-lg-12">
                                        ...
                                        {{-- modal end --}}
                                            ...
                                            <div class="button-items mt-4" style="float:right;">
                                                ...
                                                @if($get_chiplevel_count > 0)
                                                <button type="button" class="btn btn-warning waves-effect waves-light"  data-bs-toggle="modal" data-bs-target="#chiplevel_details_modal">
                                                                ...
                                                                <form method="POST" action="{{ route('chiplevel.update',$get_chiplevel->id) }}">
                                                                    ...
                                                                    @method('PATCH')
                                                                        <div class="form-group mb-3">
                                                                            ...
                                                                            <div class="col-lg-12">
                                                                                <label class="col-form-label" style="float:left;">Service Charge(₹)</label>
                                                                                <input type="number" class="form-control" name="service_charge" value="{{ $get_chiplevel->service_charge }}">
                                                                            ...
                                                                            <div class="col-lg-12">
                                                                                <label class="col-form-label" style="float:left;">Return Date</label>
                                                                                <input type="date" class="form-control" name="return_date" value="{{ $get_chiplevel->return_date }}">
                                                                                @error('return_date')
                                                                                    <span class="text-danger">{{$message}}</span>
                                                                                @enderror
                                                                            </div>
                                                                            <div class="col-lg-12">
                                                                                ...
                                                                                <select class="form-control select2" data-dropdown-parent="#chiplevel_details_modal" name="handover_staff" style="width:100%;">
                                                                                    <option selected disabled>Select</option>
                                                                                    @php
                                                                                        $get_staff = DB::table('staffs')->get();
                                                                                    @endphp
                                                ...
                                                {{-- modal end --}}
                                                @else
                                                    <button type="button" class="btn btn-warning waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#chiplevel_modal">
                                                ...
                                                <div id="chiplevel_modal" class="modal fade bs-example-modal-lg" role="dialog" aria-labelledby="myLargeModalLabel">
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="POST" action="{{ route('service_store',$consignments->id) }}">
                                                                    @csrf
                                                                        <div class="form-group mb-3">
                                                                            <div class="col-lg-12">
                                                                                <label class="col-form-label" style="float:left;">Date</label>
                                                                            ...
                                                                            <div class="col-lg-12">
                                                                                <label class="col-form-label" style="float:left;">Service Type</label>
                                                                                <select class="form-control select2" data-dropdown-parent="#chiplevel_modal" name="product_service_type" id='product_service_type' onchange="show_fields(this.value)" style="width:100%;">
                                                                                    <option selected disabled>Select</option>
                                                                            ...
                                                                            <div class="col-lg-12" id="chip_servicer_div" style="display: none;">
                                                                                ...
                                                                                <select class="form-control select2" data-dropdown-parent="#chiplevel_modal" name="chip_servicer_name" id="chip_servicer_name" onchange="add_servicer(this.value)" style="width:100%;">
                                                                                    <option selected disabled>Select</option>
                                                                                    <option value="add_servicer">Add New Servicer</option>
                                                                                    @php
                                                                                        $get_servicer = DB::table('chiplevel_servicers')->get();
                                                                                    @endphp
                                                                                    @foreach ( $get_servicer as $servicer)
                                                                                        <option value="{{ $servicer->servicer_name }}">{{ $servicer->servicer_name }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                            ...
                                                                            <div class="col-lg-12" id="warrenty_servicer_div" style="display: none;">
                                                                                ...
                                                                                <select class="form-control select2" data-dropdown-parent="#chiplevel_modal" name="warrenty_servicer_name" onchange="get_seller_contact(this.value)" style="width:100%;">
                                                                                    <option selected disabled>Select</option>
                                                                                    @php
                                                                            ...
                                                                            <div class="col-lg-12" id="staff_div" style="display: none;">
                                                                                <label class="col-form-label" style="float:left;">Staff Name</label>
                                                                                <select class="form-control select2" data-dropdown-parent="#chiplevel_modal" name="staff_name" style="width:100%;">
                                                                                    <option selected disabled>Select</option>
                                                                                    @php
                                                                                        $get_staff = DB::table('staffs')->get();
                                                                                    @endphp
