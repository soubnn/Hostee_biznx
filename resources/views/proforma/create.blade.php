                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="invoice_number" name="invoice_number" type="text" class="form-control" value="{{ old('invoice_number') }}">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="invoice_date" name="invoice_date" type="date" class="form-control" value="{{ Carbon\carbon::now()->format('Y-m-d') }}" >
                                                        @error('invoice_date')
                                                            <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div id="customer_name_select">
                                                            <select class="select2 form-control" onchange="set_name_select(this.value)">
                                                                ...
                                                                <option value="New Customer" {{ old('customer_name') === 'New Customer' ? 'selected' : '' }}>New Customer</option>
                                                                @foreach ( $customers as $customer)
                                                                    <option value="{{ $customer->id }}"{{ old('customer_name') == $customer->name ? 'selected' : '' }}>{{ $customer->name }}, {{ $customer->place }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                        ...
                        {{-- -----------------------------------------product div--------------------------- --}}
                                                <div class="col-sm-12" id="product_div">
                                                                ...
                                                                <tr id="row0">
                                                                    <td id="td_product_select0" style="max-width: 150px;">
                                                                        <select class="form-control select2" name="estimate_product[]" id='estimate_product0' onchange="get_product_details(this.value,0)" style="width: 100%">
                                                                            ...
                                                                            <option value="new product"{{ old('estimate_product.0') === 'new product' ? 'selected' : '' }}>{ New Product }</option>
                                                                            @php
                                                                                $products = DB::table('products')->get();
                                                                            @endphp
                                                                            @foreach ($products as $product)
                                                                                <option value="{{ $product->id }}"{{ old('estimate_product.0') == $product->id ? 'selected' : '' }}>[{{ $product->product_code }}] {{ $product->product_name }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </td>
                                                                    ...
                                                                    <td id="total0" class="Total gstTD" style="display: none" onchange="calculateGSTAndTotal(0)">₹0</td>
                                                                    <td style="display: none" class="gstTD">
                                                                        <select class="form-control" name="product_tax[]" id="product_tax0" onchange="calculateNewGST(this.value,0)" style="width:100%;">
                                                                            <option value="0" id="0Value_0" selected>0</option>
                                                                    ...
                                                                    <td id="gst0" style="display: none" class="gstTD">0</td>
                                                    ...
                                                    <div class="d-flex flex-wrap gap-2">
                                                        <button type="submit" id="btn_submit_product" class="btn btn-primary waves-effect waves-light" onclick="this.disabled=true;this.innerHTML='Saving..';this.form.submit();" disabled>Save Details</button>
                                                    </div>
                                                </div>
                                            </form>
                    {{-- ---------------------------------system div----------------------------------------------------- --}}
